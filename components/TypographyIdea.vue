        ...
        <div class="ticket__co">
          ...
          >
            ...
            <g opacity=".85" fill="#F4F5F6">
              ...
              />
              <path
                d="M41.7 38.5c.1 0 .1-.1.2-.1-.3.1-.5.2-.7.4.2 0 .3-.2.5-.3z"
              />
            </g>
            <path
              fill="#F4F5F6"
          ...
          <span class="ticket__co-name">Flutter App Contest</span>
          <span class="u-upper ticket__co-subname">2019 - 2020</span>
        </div>
      </div>
      <div class="ticket__body">
        <p class="ticket__route">Idea Award</p>
        <p class="ticket__description">
          Novelty, inventive step and originality
        </p>
